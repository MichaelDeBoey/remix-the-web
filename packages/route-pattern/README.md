...
pattern.match('https://remix.run/blog/2024-01-15/react-server-components');
// { params: { year: '2024', month: '01', day: '15', slug: 'react-server-components' } }

pattern.match('https://remix.run/blog/2024-01-15/react-server-components.html');
// { params: { year: '2024', month: '01', day: '15', slug: 'react-server-components' } }
```
...
pattern.match('https://example.com/blog/react-tips');
// { params: { id: 'react-tips' } }
```
